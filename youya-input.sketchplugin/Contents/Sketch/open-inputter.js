...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/open-inputter.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  browserWindow.once("ready-to-show", function () {
    if (!selection.isEmpty && selection.layers[0].type == "Text") {
      ...
      browserWindow.webContents.executeJavaScript(Object(_parse_text__WEBPACK_IMPORTED_MODULE_2__["default"])(value, selection.layers[0].id));
    }

    browserWindow.show();
  });
  browserWindow.webContents.on("nativeLog", function (value) {
    var text_layer = document.getLayerWithID(value.id);
...
//# sourceMappingURL=open-inputter.js.map