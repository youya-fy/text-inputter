...
/* harmony default export */ __webpack_exports__["default"] = (function (text_from_layer, id) {
  // 此处需要将换行符转为<br> 否则无法正常执行executeJavaScript
  var text = text_from_layer.replace(/[\n\r]/g, "<br>");
...
/*!**********************************!*\
  !*** ./src/selection-changed.js ***!
  \**********************************/
/*! exports provided: changeHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _parse_text__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parse-text */ "./src/parse-text.js");
...
function changeHandler(context) {
  if (!Object(sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_1__["isWebviewPresent"])("youya-inputter.inputter")) return;
  var selection = document.selectedLayers;

  if (!selection.isEmpty && selection.layers[0].type == "Text") {
    var value = selection.layers[0].text;
    Object(sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_1__["sendToWebview"])("youya-inputter.inputter", Object(_parse_text__WEBPACK_IMPORTED_MODULE_2__["default"])(value, selection.layers[0].id));
  }
}
...
that['changeHandler'] = __skpm_run.bind(this, 'changeHandler');
that['onRun'] = __skpm_run.bind(this, 'default')

//# sourceMappingURL=selection-changed.js.map